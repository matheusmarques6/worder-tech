    ...
    >
      ...
      <SettingsCard title="Widget" description="Personalize a aparência do chat widget no seu site.">
        ...
        <div>
          ...
          <div className="mt-1.5 flex justify-end p-6 bg-muted border border-separator" style={{ borderRadius: "10px" }}>
            <div className="flex flex-col items-end gap-3">
              ...
              <motion.div
                ...
                className="w-[260px] bg-card border border-border shadow-lg overflow-hidden"
              ...
              >
                ...
                <div className="p-3 space-y-2">
                  <div
                    className="text-[11px] text-text-primary px-3 py-2 bg-muted max-w-[85%]"
                ...
                <div className="px-3 pb-3">
                  <div
                    className="w-full h-8 bg-muted border border-border flex items-center px-3"
        ...
        <div>
          ...
          <div className="flex items-center gap-3 mt-1.5">
            <input
              ...
              className="w-10 h-10 border border-border cursor-pointer p-0.5 bg-card"
              style={{ borderRadius: "10px" }}
            />
            <input
              type="text"
              value={corPrimaria}
              onChange={(e) => setCorPrimaria(e.target.value)}
              className="flex-1 px-4 py-2.5 text-sm border border-border bg-card outline-none focus:border-worder-primary transition-colors font-mono"
              style={{ borderRadius: "10px" }}
            />
          </div>
        </div>
        ...
        <div>
          ...
          <div className="relative mt-1.5">
            <textarea
              ...
              value={SNIPPET_CODE}
              rows={2}
              className="w-full px-4 py-3 text-[13px] border border-border bg-table-header text-[#E0E0E0] outline-none resize-none"
