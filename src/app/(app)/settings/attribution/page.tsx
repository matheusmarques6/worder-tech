  ...
  return (
    ...
    >
      ...
      >
                ...
                >
                  ...
                  <td className="px-4 py-3">
                    <select
                      ...
                      className="px-3 py-1.5 text-[12px] border border-[#E0E0E0] bg-white outline-none focus:border-[#F26B2A] transition-colors appearance-none cursor-pointer"
        ...
        <div className="mt-4">
          <button
            className="px-4 py-2 text-[12px] font-semibold border border-[#E0E0E0] text-text-primary hover:bg-[#FAFAFA] transition-colors"
