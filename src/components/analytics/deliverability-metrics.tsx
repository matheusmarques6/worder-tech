          ...
          return (
            <motion.div
              ...
              className={`p-4 border transition-all ${
                isDone ? "border-success/20 bg-success/5" : "border-[#E0E0E0] bg-[#FAFAFA]"
              }`}
                  ...
                  {!isDone && (
                    <div className="flex items-center gap-2 mt-3">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-[11px] font-medium text-text-muted hover:text-text-primary border border-[#E0E0E0] hover:bg-white transition-colors"
