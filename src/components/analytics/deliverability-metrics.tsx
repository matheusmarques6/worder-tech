          ...
          return (
            <motion.div
              ...
              className={`p-4 border transition-all ${
                isDone ? "border-success/20 bg-success/5" : "border-border bg-background"
              }`}
                  ...
                  {!isDone && (
                    <div className="flex items-center gap-2 mt-3">
                      ...
                      <button
                        ...
                        className="px-3 py-1.5 text-[11px] font-medium text-text-muted hover:text-text-primary border border-border hover:bg-card transition-colors"
