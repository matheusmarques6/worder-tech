    ...
    >
      <div className="flex items-center justify-between mb-4">
        ...
        <select
          ...
          className="px-3 py-1.5 text-[12px] border border-[#E0E0E0] bg-white outline-none focus:border-worder-primary transition-colors appearance-none cursor-pointer"
      ...
      {/* Sub-tabs */}
      <div className="flex items-center gap-1 mb-5 border-b border-[#F0F0F0]">
        {subTabs.map((tab) => (
          <button
            key={tab.id}
        ...
        <div className="grid grid-cols-2 md:grid-cols-4 gap-4">
          {[
            ...
            <motion.div
              ...
              className="p-4 bg-[#FAFAFA] border border-[#F0F0F0]"
        ...
        <div className="space-y-2">
          {[
            ...
            <motion.div
              ...
              transition={{ delay: i * 0.05 }}
              className="flex items-center justify-between px-4 py-3 bg-[#FAFAFA] border border-[#F0F0F0] hover:bg-[rgba(242,107,42,0.03)] transition-colors"
              style={{ borderRadius: "10px" }}
            >
              <div>
