    ...
    >
      ...
      <AnimatePresence mode="wait">
        ...
        >
          ...
          {step === 2 && (
            <div
              className="bg-background-card border border-border p-5 space-y-3"
              style={{ borderRadius: "var(--radius-card)", boxShadow: "var(--shadow-card)" }}
            >
          ...
          {step === 3 && (
            <div
              className="bg-background-card border border-border p-6 space-y-5"
              style={{ borderRadius: "var(--radius-card)", boxShadow: "var(--shadow-card)" }}
            >
          ...
          {step === 4 && (
            <div className="space-y-4">
              <div
                className="bg-background-card border border-border p-6 space-y-4"
                style={{ borderRadius: "var(--radius-card)", boxShadow: "var(--shadow-card)" }}
              >
