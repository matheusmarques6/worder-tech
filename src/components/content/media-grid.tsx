    ...
    <div className="space-y-4">
      ...
      {selectedIds.length > 0 && (
        ...
        >
          ...
          <button className="flex items-center gap-1.5 px-3 py-1.5 text-[13px] text-text-secondary hover:bg-card/80 rounded-lg transition-colors">
        ...
        {filtered.map((item, i) => {
          ...
          return (
            <motion.div
              ...
              className={`group relative bg-card border overflow-hidden cursor-pointer transition-all duration-200 ${
              ...
              >
                ...
                <div className="absolute inset-0 bg-black/0 group-hover:bg-black/30 transition-all duration-200 flex items-center justify-center gap-1.5 opacity-0 group-hover:opacity-100">
                  <button
                    ...
                    className="flex items-center justify-center w-8 h-8 rounded-full bg-card shadow-md hover:scale-105 transition-transform"
                  >
